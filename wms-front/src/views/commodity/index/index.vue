...
import { get, post, put, del, tip, export2excel } from "@/common";
...
// 监视器，监听模糊查询表单中仓库的变化
watch(()=>params.storeId, 
  (newStoreId, oldStoreId) => getCommodityPageList(),
  // immdiate: 默认情况下，侦听器需要 data 值改变了才会生效，若需要侦听器一进入页面就生效，那就需要使用 immediate
