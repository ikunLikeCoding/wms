...
) ENGINE = InnoDB AUTO_INCREMENT = 98 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '权限表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `brand`  (
  ...
  `brand_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `brand_leter` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `brand_desc` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`brand_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '品牌' ROW_FORMAT = Dynamic;
...
CREATE TABLE `buy_list`  (
  ...
  `buy_user` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `is_in` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '0 否 1 是',
  PRIMARY KEY (`buy_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 48 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '采购单' ROW_FORMAT = Dynamic;
...
INSERT INTO `buy_list` VALUES (20, 19, 1, 499, 0, '2022-04-13 10:28:39', 2, 2, 'mark', '46462275758', '0');
...
INSERT INTO `buy_list` VALUES (29, 21, 1, 2, NULL, '2022-04-19 12:06:14', 2, 4, 'vick', '1234565432354', '0');
INSERT INTO `buy_list` VALUES (30, 21, 1, 3, NULL, '2022-04-19 12:09:29', 2, 4, 'mel', '33333333333', '0');
INSERT INTO `buy_list` VALUES (31, 22, 1, 5, NULL, '2022-04-19 12:13:23', 5, 6, 'vick', '44444444444', '0');
...
) ENGINE = InnoDB AUTO_INCREMENT = 47 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '入库单' ROW_FORMAT = Dynamic;
...
INSERT INTO `in_store` VALUES (38, 1, 7, 15, 1, '2022-04-21 08:56:47', '0');
INSERT INTO `in_store` VALUES (39, 1, 22, 50, 1, '2022-04-21 09:15:07', '1');
INSERT INTO `in_store` VALUES (40, 1, 5, 600, 1, '2022-04-21 09:35:35', '0');
...
INSERT INTO `in_store` VALUES (45, 1, 25, 80, 28, '2022-04-24 15:50:54', '0');
...
CREATE TABLE `out_store`  (
  ...
  `create_by` int NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `is_out` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '0 否 1 是',
  PRIMARY KEY (`outs_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '出库单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `place`  (
  ...
  `place_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `place_num` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `introduce` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `is_delete` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '0:可用  1:不可用',
  PRIMARY KEY (`place_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '产地' ROW_FORMAT = Dynamic;
...
CREATE TABLE `product`  (
  ...
  `product_num` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `product_invent` int NULL DEFAULT NULL,
  `type_id` int NULL DEFAULT NULL,
  `supply_id` int NULL DEFAULT NULL,
  `place_id` int NULL DEFAULT NULL,
  `unit_id` int NULL DEFAULT NULL,
  `introduce` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `up_down_state` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '0 下架 1 上架',
  ...
  `create_by` int NULL DEFAULT NULL,
  `update_by` int NULL DEFAULT NULL,
  `imgs` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `product_date` datetime NULL DEFAULT NULL,
  `supp_date` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`product_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, 1, 3, '海尔电视d1-1111', 'haier1001', 319, 3, 4, 5, 6, '43242342342343', '1', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2022-04-08 15:24:14', 1, 1, '/img/upload/haier_tv.jpg', '2016-02-22 08:00:00', '2028-10-11 08:00:00');
INSERT INTO `product` VALUES (5, 2, 3, '海尔洗衣机h1-1131', 'haierh11132', 157, 2, 2, 3, 6, 'weqweqweqwe', '1', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2017-12-08 17:14:12', 1, 1, '', '2016-02-23 00:00:00', '2027-02-23 00:00:00');
...
INSERT INTO `product` VALUES (7, 1, 3, '海尔洗衣机h1-1132', 'haier1002', 101, 2, 4, 5, 6, 'weqweqweqwe', '0', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2022-04-08 15:25:14', 1, 1, '/img/upload/haier_wm.jpg', '2016-02-22 08:00:00', '2030-09-17 08:00:00');
INSERT INTO `product` VALUES (11, 1, 3, '海尔洗衣机h1-1136', 'haier1003', 111, 2, 4, 3, 6, '洗的很干净', '1', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2022-04-08 15:41:02', 1, 1, '/img/upload/haier_wm.jpg', '2019-10-22 08:00:00', '2027-02-22 08:00:00');
INSERT INTO `product` VALUES (12, 1, 3, '海尔洗衣机h1-1137', 'haierh11138', 222, 2, 2, 3, 6, 'weqweqweqwe', '1', 3899.00, 4999.00, 4599.00, '2017-12-06 12:09:12', '2022-04-08 15:44:51', 1, 1, '/img/upload/h1130.png', '2016-02-22 08:00:00', '2017-02-22 08:00:00');
...
INSERT INTO `product` VALUES (21, 1, 1, '香蕉', 'xg123', 270, 6, 2, 4, 3, '香蕉啊', '0', 2.50, 5.50, 3.50, '2022-04-08 11:58:47', '2022-04-08 15:11:48', 1, 1, '/img/upload/banana.png', '2017-12-19 08:00:00', '2017-12-29 08:00:00');
INSERT INTO `product` VALUES (22, 1, 2, '空调', 'midea1001', 170, 7, 5, 6, 6, '很凉快', '0', 2000.00, 3999.00, 3699.00, '2022-04-08 15:39:56', NULL, 1, NULL, '/img/upload/midea_ac.png', '2022-03-24 08:00:00', '2034-12-20 08:00:00');
...
INSERT INTO `product` VALUES (25, 1, 2, '风扇', 'midea1004', 7, 8, 5, 6, 6, '没有风，只有声。。。', '1', 100.00, 299.00, 249.00, '2022-04-08 15:44:22', '2022-04-24 15:44:07', 1, 31, '/img/upload/midea_blower.png', '2022-04-01 08:00:00', '2038-09-15 08:00:00');
INSERT INTO `product` VALUES (27, 1, 1, '西瓜2号', 'xg9528', 100, 6, 2, 3, 2, '皮薄保甜', '0', 3.00, 5.00, 4.00, '2022-04-08 11:19:38', '2022-04-24 15:48:59', 1, 31, '/img/upload/watermelon.png', '2022-04-09 08:00:00', '2022-06-05 08:00:00');
...
INSERT INTO `product` VALUES (30, 1, 2, '风扇', 'midea1003', 20, 8, 5, 6, 6, '没有风，只有声。。。', '0', 100.00, 299.00, 249.00, '2022-04-08 15:44:22', NULL, 1, NULL, '/img/upload/midea_blower.png', '2022-04-01 08:00:00', '2038-09-15 08:00:00');
...
CREATE TABLE `product_type`  (
  ...
  `type_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `type_desc` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`type_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品分类表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '角色表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 746 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '角色权限表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `store`  (
  ...
  `store_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `store_num` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `store_address` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `concat` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`store_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '仓库表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `supply`  (
  ...
  `supply_num` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `supply_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `supply_introduce` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  `concat` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `phone` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `address` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `is_delete` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '0:可用  1:不可用',
  PRIMARY KEY (`supply_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '供货商' ROW_FORMAT = Dynamic;
...
CREATE TABLE `unit`  (
  ...
  `unit_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `unit_desc` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`unit_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '规格单位表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `user_info` VALUES (1, 'admin', '超级管理员', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '1', '0', 1, '2017-11-14 15:14:31', 1, '2022-04-24 15:33:12');
INSERT INTO `user_info` VALUES (3, 'root', 'root', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '1', '0', 1, '2017-11-16 19:31:49', 1, '2022-03-16 17:28:34');
INSERT INTO `user_info` VALUES (5, 'asdsjkb', '可爱吧1', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '1', '1', 1, '2017-11-16 21:25:41', 1, '2022-03-15 14:57:44');
INSERT INTO `user_info` VALUES (6, 'dasdasf', 'start', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', '1', '1', '1', 1, '2017-11-16 21:36:41', 1, '2017-11-21 10:45:57');
INSERT INTO `user_info` VALUES (7, 'fsdfs', 'start', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', '1', '0', '1', 1, '2017-11-16 21:39:09', 1, '2017-11-21 10:44:35');
INSERT INTO `user_info` VALUES (10, 'root', 'root', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', '3', '0', '1', 1, '2017-11-17 10:48:24', NULL, NULL);
INSERT INTO `user_info` VALUES (19, 'static', 'static', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', '2', '0', '0', 1, '2017-11-29 22:10:51', NULL, NULL);
INSERT INTO `user_info` VALUES (20, 'public', 'public', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', '2', '1', '0', 1, '2017-12-01 14:40:15', NULL, NULL);
INSERT INTO `user_info` VALUES (21, 'wk', '晴空', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '0', '0', 1, '2022-03-17 17:24:00', NULL, NULL);
INSERT INTO `user_info` VALUES (23, 'zhangsan', '张三', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '0', '1', 1, '2022-04-08 16:18:52', NULL, NULL);
INSERT INTO `user_info` VALUES (24, 'lisi', '李四', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '0', '1', 1, '2022-04-08 16:20:19', NULL, NULL);
INSERT INTO `user_info` VALUES (25, 'wangwu', '王五', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '0', '1', 1, '2022-04-08 16:20:43', NULL, NULL);
INSERT INTO `user_info` VALUES (26, 'liuliu', '刘六', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '0', '1', 1, '2022-04-08 16:21:14', NULL, NULL);
INSERT INTO `user_info` VALUES (27, 'wzl', '我这里', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '1', '1', 1, '2022-04-19 17:09:13', NULL, NULL);
INSERT INTO `user_info` VALUES (28, 'caigou', '采购', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '1', '0', 1, '2022-04-22 13:42:35', NULL, NULL);
INSERT INTO `user_info` VALUES (29, 'ruku', '入库管理员', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '1', '0', 1, '2022-04-22 13:50:25', NULL, NULL);
INSERT INTO `user_info` VALUES (30, 'chuku', '出库管理员', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '1', '0', 1, '2022-04-22 13:53:20', NULL, NULL);
INSERT INTO `user_info` VALUES (31, 'shangpin', '商品管理员', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '1', '0', 1, '2022-04-22 13:57:11', NULL, NULL);
INSERT INTO `user_info` VALUES (32, 'diaohuo', '调货管理员', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '1', '0', 1, '2022-04-24 15:23:22', NULL, NULL);
INSERT INTO `user_info` VALUES (33, 'cangku', '仓库管理员', '$2a$10$vYtS5Bi.4T80TIFOcE96oeomUIo4c3xod7ptb1Yr47hf7QCoG818y', NULL, '1', '0', 1, '2022-04-24 15:23:48', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户角色表' ROW_FORMAT = Dynamic;
